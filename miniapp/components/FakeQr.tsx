...
export default function FakeQr({ size = 72 }: { size?: number }) {
  const dimension = Math.max(32, Math.min(size, 120));
  return (
    <svg
      width={dimension}
      height={dimension}
      ...
      aria-hidden="true"
    >
      <rect x="3" y="3" width="5" height="5" rx="1" stroke="#000000" strokeWidth="2" />
      <rect x="3" y="16" width="5" height="5" rx="1" stroke="#000000" strokeWidth="2" />
      <rect x="16" y="3" width="5" height="5" rx="1" stroke="#000000" strokeWidth="2" strokeLinejoin="round" />
