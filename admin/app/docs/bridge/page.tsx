  ...
  return (
    <div>
      ...
      <ol>
        ...
        <li>Отредактируйте переменные: <code>API_BASE</code>, <code>MERCHANT_ID</code>, <code>BRIDGE_PORT</code>, <code>BRIDGE_SECRET</code>, <code>STAFF_KEY</code>.</li>
      ...
      <ol>
        ...
        <li>В переменные среды службы добавьте: <code>API_BASE</code>, <code>MERCHANT_ID</code>, <code>BRIDGE_PORT</code>, <code>BRIDGE_SECRET</code>, <code>STAFF_KEY</code>.</li>
...
server {
  ...
  location / {
    ...
    proxy_pass http://127.0.0.1:18080;
      ...
      <p>Включите «Требовать подпись Bridge» в настройках мерчанта. Заголовок <code>X-Bridge-Signature</code> формируется как <code>v1,ts=...,sig=Base64(HMAC_SHA256(secret, ts + '.' + body))</code>.</p>
