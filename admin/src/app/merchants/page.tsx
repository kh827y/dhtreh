...
type SubscriptionFilter = 'all' | 'active' | 'expiring' | 'expired';
  ...
  return (
    <main style={{ maxWidth: 980, margin: '32px auto', fontFamily: 'system-ui, Arial' }}>
      ...
      <div style={{ display:'flex', gap:12, flexWrap:'wrap', alignItems:'center', marginBottom: 16 }}>
        ...
        <label style={{ display:'flex', flexDirection:'column', gap:4, color:'#cbd5e1', fontSize:13 }}>
          Подписка
          <select value={subscriptionFilter} onChange={e=>setSubscriptionFilter(e.target.value as SubscriptionFilter)} style={{ padding: 8, minWidth:180 }}>
