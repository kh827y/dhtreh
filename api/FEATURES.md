...
### 6. Уведомления (`/sms/*`, `/push/*`)

#### SMS (SMSC.RU)
- **Транзакционные** - чеки, баллы
- **Маркетинговые** - с проверкой согласий
- **OTP коды** - верификация
- **Массовые рассылки** по сегментам
- **Шаблоны** для малого бизнеса
...
### 8. Отчеты (`/reports/*`)
- **Форматы**: Excel, PDF, CSV
- **Типы отчетов**:
  - Транзакции с детализацией
  - База клиентов
