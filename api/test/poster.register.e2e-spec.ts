...
// Negative-path: invalid config should 400 and increment pos_requests_total error for Poster

describe('Poster register (e2e, negative)', () => {
  ...
  it('returns 400 on invalid config and exports error metric', async () => {
    ...
    await request(app.getHttpServer())
      .post('/integrations/poster/register')
