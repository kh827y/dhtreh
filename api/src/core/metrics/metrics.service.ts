...
const createMap = (): CMap => Object.create(null) as CMap;

@Injectable()
export class MetricsService implements OnModuleDestroy {
  private counters: CMap = createMap();
  private sums: CMap = createMap();
  private counts: CMap = createMap();
  private gauges: CMap = createMap();
