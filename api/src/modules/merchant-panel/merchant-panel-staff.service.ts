...
import type { StaffFilters, UpsertStaffPayload } from './merchant-panel.types';
...
@Injectable()
export class MerchantPanelStaffService {
  private readonly logger = new Logger(MerchantPanelStaffService.name);
  ...
  private mapStaff(
    member: Prisma.StaffGetPayload<{
      include: ReturnType<MerchantPanelStaffService['staffInclude']>;
    }>,
    overrides: {
