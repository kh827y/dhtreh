...
function createCacheMock(): CacheStub {
  return {
    getMerchantSettings: mockFn().mockResolvedValue(null),
    getOutlet: mockFn().mockResolvedValue(null),
    getStaff: mockFn().mockResolvedValue(null),
  };
}
