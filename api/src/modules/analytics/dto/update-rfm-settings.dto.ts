...
export class UpdateRfmSettingsDto {
  ...
  @ValidateIf((dto: UpdateRfmSettingsDto) => dto.recencyMode === 'manual')
  @IsInt()
  @Min(1)
  recencyDays?: number;
  ...
  @ValidateIf((dto: UpdateRfmSettingsDto) => dto.frequencyMode === 'manual')
  @IsInt()
  @Min(1)
  ...
  @ValidateIf((dto: UpdateRfmSettingsDto) => dto.moneyMode === 'manual')
  @IsInt()
  @Min(0)
