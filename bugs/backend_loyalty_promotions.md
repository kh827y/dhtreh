...
### 1) Неверная аналитика уникальных клиентов в деталях акции
...
### 2) Детализация использований акции всегда показывает `rewardType=POINTS`
...
### 3) Баллы по «точечным» акциям без товарных целей не участвуют в расчёте бонусов
...
### 4) Отсутствует валидация диапазона дат акции (`startAt`/`endAt`)
