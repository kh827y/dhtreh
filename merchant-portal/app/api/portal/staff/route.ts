...
export function buildStaffPayload(body: any) {
  ...
  if (body?.password !== undefined) payload.password = body.password == null ? null : String(body.password);
  if (body?.currentPassword !== undefined) payload.currentPassword = body.currentPassword == null ? null : String(body.currentPassword);
