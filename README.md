...
- После успешной операции клиент увидит шторку оценки визита; кнопки «Поделиться» появляются, если в портале (`/reviews`) включены внешние площадки (Яндекс.Карты / 2ГИС / Google).
