...
## Хотфикс 2025-11-14 — Portal: аналитика «Портрет клиента»
- [x] Подключить реальные аудитории к фильтру страницы и прокинуть `audienceId` в аналитический API.
- [x] Пересчитать портрет клиента по возрастам в годах и по полу×возрасту для реальных аудиторий на backend.
- [x] Обновить фронтенд: круговая диаграмма с русскими подписями, отдельные столбиковые метрики по полу и линейные графики с ползунками для возраста и пола×возраста.
