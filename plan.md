...
- [x] Удалить фронтовые заглушки для сотрудников/групп/аналитики, переключить карточку сотрудника и справочники на реальные данные без дефолтных PIN и фиктивных групп.
