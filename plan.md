...
- [x] Перерисовать авторизацию и основной поток кассира в яркой градиентной теме под мобильные устройства.
- [x] Центрировать десктопную версию, добавить цветные карточки шагов, кнопки и навигацию с иконками.
- [x] Обновить разделы «История», «Рейтинг», «Возвраты» под новую цветовую схему и градиенты.
- [x] Переработать модалку сканера: светлый фон, градиентная рамка и поле ручного ввода токена.
