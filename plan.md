...
- [x] Miniapp: карточка уровня и прогресс на главной/странице QR берут реальные данные о начислении, списании и минимальной оплате из API уровней.
...
- [x] Портал «Уровни клиентов»: подключил реальный API, автосоздал «Базовый»/«VIP» и добавил учёт minPayment при списании.
