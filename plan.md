...
- ✅ Merchant Portal: раздел «Клиенты» обновлён — список с фильтрами и массовыми действиями, карточка клиента, страницы импорта и комплиментов, модалка создания/редактирования, настройки антифрода и журнал событий.
