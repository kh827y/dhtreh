...
- ✅ Уровни лояльности: группы «Базовый»/«VIP» создаются автоматически, проценты начисления/списания и минимальная сумма оплаты применяются в quote/commit реального API.
