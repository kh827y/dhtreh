...
- Выполнено:
  ...
  - Legacy ваучеры удалены: сервисы, контроллеры и тесты `vouchers/*` заменены на единый `PromoCodesService`, работающий с реальными таблицами `PromoCode`/`PromoCodeUsage`.
