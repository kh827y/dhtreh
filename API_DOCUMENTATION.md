...
| 422 | ValidationFailed | Ошибка валидации |
...
```json
{
  ...
  "statusCode": 400,
  "requestId": "req_lh9o9_8u1k4m",
  "path": "/loyalty/qr",
  "timestamp": "2026-01-19T18:20:00.000Z"
}
```
...
Ключи хранятся по `IDEMPOTENCY_TTL_HOURS` (по умолчанию 72 часа). При повторном запросе с тем же ключом вернется кешированный ответ.
